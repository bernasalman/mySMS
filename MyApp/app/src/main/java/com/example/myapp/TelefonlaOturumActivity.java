    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DogrulamaKoduGondermeButtonu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(TelefonlaOturumActivity.this, "Telefon numarası boş olamaz!", Toast.LENGTH_LONG).show();
                }
                else
                {
                    //Yükleniyor penceresi
        ...
        callbacks= new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            {   //Yukleme penceresi
                ...
                Toast.makeText(TelefonlaOturumActivity.this, "Geçersizi telefon numarası!Lütfen ülke kodunuzla birlikte tekrar numaranızı girin..", Toast.LENGTH_LONG).show();
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                Toast.makeText(TelefonlaOturumActivity.this, "Kod gönderildi!", Toast.LENGTH_LONG).show();
        ...
        mYetki.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            yuklemeBar.dismiss();
                            Toast.makeText(TelefonlaOturumActivity.this, "Tebrikler.. Oturumunuz açıldı..", Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(TelefonlaOturumActivity.this, "Hata: "+hataMesaji, Toast.LENGTH_SHORT).show();
